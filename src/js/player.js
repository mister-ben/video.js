 ...
 *
 * @typedef {Object} PlayerOptions Options for a Video.js player
 ...
 * @property {boolean} [normalizeAutoplay] Whether to treat autoplay set to `true` asVideo.js's `'play'`
 ...
 *
 * @typedef { import('./component').ComponentOptions & PlayerOptions } VideoJsPlayerOptions
 *
 */
